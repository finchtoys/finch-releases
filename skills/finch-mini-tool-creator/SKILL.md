...
| Right-panel Webview / file or image annotations | `reference/ui.md` §7 and `reference/finch.d.ts` → `AppPanel`, `WebviewBridgeApi`, origin rules, Composer context drafts; static launcher entry via `contributes.appPanel` (see §4) |
