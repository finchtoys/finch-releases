...
def cmd_add(reg_type, args):
    ...
    # Build EN entry
    en_entry = {}
    for field in ["id", "name", "author", "description", "repo", "npm", "extensionType", "installScope", "categories"]:
        if field in args:
...
def cmd_update(reg_type, eid, args):
    ...
    # Update EN fields
    en_fields = ["name", "author", "description", "repo", "npm", "extensionType", "installScope"]
